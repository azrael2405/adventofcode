...
mv day_$1/day$1/dayX_test.go day_$1/day$1/day${1}_test.go
sed -i 's/use (/use (\n\t.\/day_'$1'/' go.work
...
sed -i 's/dayX/day'$1'/g' day_$1/day$1/day${1}_test.go
sed -i 's/day_X/day_'$1'/g' day_$1/day$1/day${1}_test.go
git add .
