...
func Test_part1(t *testing.T){
	test_data := parse_input_from_file(`E:\projects\adventofcode2022\2023\day_X\test1.txt`)
	expected_answer := 6440
	answer := dayX.Parse_answer_one(test_data)
...
func Test_part2(t *testing.T){
	...
	answer := dayX.Parse_answer_two(test_data)
	if answer != expected_answer{
