...
func Test_part1(t *testing.T) {
	test_data := parse_input_from_file(`E:\projects\adventofcode2022\2023\day_15\test1.txt`)
	expected_answer := 1320
	answer := day15.Parse_answer_one(test_data)
...
func Test_part2(t *testing.T) {
	...
	answer := day15.Parse_answer_two(test_data)
	if answer != expected_answer {
